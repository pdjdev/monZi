...
#Region "Aero 그림자 효과 (Vista이상)"
    ...
    Public Function CreateDropShadow(form As Form) As Boolean
        If My.Settings.AeroEnabled Then '나중에 옵션추가시 추가
            Try
...
#Region "컨트롤 조정"
    ...
    Public Sub ZoomForm(Form As Form, ZoomFactor As Double, Refresh As Boolean, ChangeFormSize As Boolean)

        If ChangeFormSize Then
        ...
        For Each c As Control In Form.FindAllChildren
            c.Width *= ZoomFactor
            c.Height *= ZoomFactor
            c.Location = New Point(c.Location.X * ZoomFactor, c.Location.Y * ZoomFactor)
            If TypeOf c Is Label Then
                c.Font = New Font(c.Font.FontFamily, c.Font.Size * ZoomFactor)
            End If
        Next
